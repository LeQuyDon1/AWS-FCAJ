...
|-----|-----------|---------------|------------------|---------------------|
| 2 | Kết nối frontend đến các endpoint Cognito. <br>- Xây UI đăng nhập và đăng ký. | 29/06/2026 | 29/06/2026 | AWS Study Group |
| 3 | Triển khai lưu token an toàn & cơ chế refresh token. <br>- Thêm interceptors cho API client. | 30/06/2026 | 30/06/2026 | AWS Study Group |
| 4 | Tích hợp frontend với các route API Gateway có bảo vệ. <br>- Kiểm tra luồng Lambda Authorizer. | 01/07/2026 | 01/07/2026 | AWS Study Group |
| 5 | Xây hệ thống xử lý lỗi toàn cục (frontend + backend). <br>- Chuẩn hóa response API. | 02/07/2026 | 02/07/2026 | AWS Study Group |
| 6 | Tăng cường giám sát bằng CloudWatch Logs & Metrics. <br>- Debug toàn bộ luồng end-to-end. | 03/07/2026 | 03/07/2026 | AWS Study Group |
