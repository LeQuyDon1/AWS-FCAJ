...
|-----|------|-------------|------------------|--------------------|
| 2 | Study REST API design, HTTP methods, and backend workflow. <br>- Design initial API endpoints for the system. | 15/06/2026 | 15/06/2026 | AWS Study Group |
| 3 | Learn **API Gateway** basics. <br>- Create routes, methods, request validation, and logging. | 16/06/2026 | 16/06/2026 | AWS Study Group |
| 4 | Learn **AWS Lambda**. <br>- Build and deploy simple CRUD Lambda functions. <br>- Test using event triggers. | 17/06/2026 | 17/06/2026 | AWS Study Group |
| 5 | Study **DynamoDB**. <br>- Design table schema. <br>- Perform CRUD operations. | 18/06/2026 | 18/06/2026 | AWS Study Group |
| 6 | Learn **Cognito Authentication**. <br>- User Pool basics. <br>- Link Cognito authorization with API Gateway routes. | 19/06/2026 | 19/06/2026 | AWS Study Group |
