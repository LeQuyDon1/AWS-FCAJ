...
|-----|-----------|--------------|------------------|--------------------|
| 2 | Học thiết kế REST API, phương thức HTTP và quy trình backend. <br>- Thiết kế các API endpoints ban đầu. | 15/06/2026 | 15/06/2026 | AWS Study Group |
| 3 | Học **API Gateway**. <br>- Tạo routes, methods, validate request và enable logging. | 16/06/2026 | 16/06/2026 | AWS Study Group |
| 4 | Tìm hiểu **AWS Lambda**. <br>- Viết và deploy các hàm CRUD cơ bản. <br>- Test bằng event triggers. | 17/06/2026 | 17/06/2026 | AWS Study Group |
| 5 | Học **DynamoDB**. <br>- Thiết kế schema. <br>- Thực hiện CRUD operations. | 18/06/2026 | 18/06/2026 | AWS Study Group |
| 6 | Học **Cognito Authentication**. <br>- Tạo User Pool. <br>- Kết nối Cognito với API Gateway. | 19/06/2026 | 19/06/2026 | AWS Study Group |
