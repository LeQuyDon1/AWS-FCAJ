...
|-----|-----------|--------------|------------------|--------------------|
| 2 | Học về authentication/authorization (JWT, Access Token, ID Token). <br>- Ôn OWASP API Security. | 22/06/2026 | 22/06/2026 | AWS Study Group |
| 3 | Tìm hiểu sâu **Cognito User Pool** và **Identity Pool**. <br>- Triển khai signup, login, refresh token flow. | 23/06/2026 | 23/06/2026 | AWS Study Group |
| 4 | Tạo **Lambda Authorizer** và gắn vào API Gateway. <br>- Thêm IAM permission. | 24/06/2026 | 24/06/2026 | AWS Study Group |
| 5 | Nâng cấp DynamoDB: <br>- Thêm secondary index. <br>- Tăng cường validation & error handling. | 25/06/2026 | 25/06/2026 | AWS Study Group |
| 6 | Kiểm thử end-to-end: <br>- Client → API Gateway → Lambda → DynamoDB. | 26/06/2026 | 26/06/2026 | AWS Study Group |
