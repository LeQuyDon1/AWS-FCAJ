...
|-----|-----------|---------------|------------------|---------------------|
| 2 | Triển khai global state management (Redux/Zustand/Context). <br>- Đồng bộ trạng thái session. | 06/07/2026 | 06/07/2026 | AWS Study Group |
| 3 | Xây dựng thư viện UI component tái sử dụng: input, modal, loader, thông báo. | 07/07/2026 | 07/07/2026 | AWS Study Group |
| 4 | Tích hợp dữ liệu backend vào UI. <br>- Thêm cơ chế fetch + auto refresh. | 08/07/2026 | 08/07/2026 | AWS Study Group |
| 5 | Tăng cường validation API & form frontend. <br>- Đảm bảo ổn định API contract. | 09/07/2026 | 09/07/2026 | AWS Study Group |
| 6 | Tối ưu performance và caching frontend. <br>- Giảm API call trùng lặp bằng memoization. | 10/07/2026 | 10/07/2026 | AWS Study Group |
